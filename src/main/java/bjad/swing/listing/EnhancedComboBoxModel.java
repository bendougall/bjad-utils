 ...
 */
public class EnhancedComboBoxModel<TYPE> extends DefaultComboBoxModel<TYPE>
{
    ...
    */
   public EnhancedComboBoxModel(Collection<TYPE> items)
   {
      this();
      add(items);
   }
   ...
   /**
    * Adds an array of items to the model without firing the 
    * events until the end (if suppression was not on before hand)
    *  
    * @param items
    *    The items to add to the model.
