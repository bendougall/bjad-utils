 ...
 *   Ben Dougall
 */
public class CountryListModel extends EnhancedListModel<CountryBean>
{
    ...
    *    display.
    */
   public CountryListModel(ICountryDisplay displayInterface) throws IllegalArgumentException
   {
